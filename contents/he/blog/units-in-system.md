...
הפתרון הקלאסי היא שיוּם טוב יותר של המתודות והמשתנים וכתיבת הערות ותיעוד. 

כן, אבל.

אבל זה לא פתרון שמבטיח כלום. עדיין ייתכן והתכניתן הנמהר לא ישים לב, 
יתבלבל או לא יבין את ההבדל בין המידות השונות 
(כמה מכם יודעים את ההבדל בין מייל ימי למייל יבשתי?)
...
ובהרחבה 
ניתן דוגמאות קוד להמחשת את הבעיתיות
...
בדוגמה זו מומחש בעיית ההמרות מיותרות שלא ניתן להתחמק מהן.
